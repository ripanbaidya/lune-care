    ...
    <section className="relative py-20 sm:py-24">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="relative">
          ...
          <div className="home-premium-card home-admin-hover relative rounded-3xl bg-gradient-to-b from-gray-900/90 to-black/85 p-5 shadow-[0_30px_80px_rgba(0,0,0,0.45)]">
            <div className="home-premium-card home-admin-hover rounded-2xl bg-black/40 p-4">
              ...
              <div className="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-3">
                {[
                  ...
                  <div
                    key={item}
                    className="home-premium-card home-admin-hover rounded-lg px-3 py-2 text-xs text-gray-300"
                  >
            ...
            <div className="mt-4 grid grid-cols-3 gap-3 text-xs text-gray-400">
              <div className="home-premium-card home-admin-hover rounded-lg p-3 flex items-center gap-2">
