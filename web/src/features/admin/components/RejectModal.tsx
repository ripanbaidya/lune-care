...
const RejectModal: React.FC<Props> = ({ doctorName, onConfirm, onCancel, isPending }) => {
            ...
            <div className="w-full max-w-md rounded-2xl border border-gray-800/60 bg-gradient-to-b from-gray-900 to-black shadow-2xl">
                ...
                <div className="flex items-start justify-between px-6 pt-6 pb-4 border-b border-gray-800/50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-sm font-semibold text-white">Reject Verification</p>
                ...
                <div className="px-6 py-5 space-y-4">
                    ...
                    <div>
                        ...
                        <div className="flex items-center justify-between mt-1">
                            ...
                            <p className="text-xs text-gray-600 ml-auto">{reason.length}/300</p>
                        </div>
                    </div>
                </div>
