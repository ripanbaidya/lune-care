...
const StatCard: React.FC<StatCardProps> = ({ label, value, icon, accent, glow, sub }) => (
    <div className={`relative overflow-hidden rounded-2xl border border-gray-800/60 bg-gradient-to-br from-gray-900/90 to-black/90 backdrop-blur-xl p-6 group hover:border-gray-700/80 transition-all duration-300`}>
        {/* Glow blob */}
        <div className={`absolute -top-6 -right-6 w-24 h-24 rounded-full blur-2xl opacity-20 group-hover:opacity-30 transition-opacity ${glow}`} />
