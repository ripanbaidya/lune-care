...
import {
    CheckCircle2, XCircle, FileText, UserCircle,
    Clock, RefreshCw, Stethoscope,
} from 'lucide-react';
import { usePendingDoctors, useVerifyDoctor, useRejectDoctor } from '../hooks/useAdmin';
...
const DoctorRow: React.FC<DoctorRowProps> = ({
                                                 doctor, onViewDocs, onApprove, onReject, isActing,
                                             }) => {
            ...
            <div className="flex items-center gap-4 min-w-0">
                ...
                <div className="min-w-0">
                    ...
                    <div className="flex items-center gap-2 flex-wrap mt-0.5">
                        {specLabel && (
                            <span className="text-xs text-blue-400 font-medium">{specLabel}</span>
                        )}
...
const PendingDoctorTable: React.FC = () => {
    ...
    const [rejectTarget, setRejectTarget] = useState<PendingDoctorResponse | null>(null);
    const [docsTarget, setDocsTarget] = useState<PendingDoctorResponse | null>(null);
        ...
        <>
            ...
            {isLoading ? (
                ...
                <div className="flex flex-col items-center py-16 gap-3 rounded-xl border border-gray-800/40 bg-gray-900/20">
                    ...
                    <p className="text-sm font-medium text-gray-400">No pending verifications</p>
                    <p className="text-xs text-gray-600">All doctor applications have been reviewed.</p>
                </div>
            ) : (
