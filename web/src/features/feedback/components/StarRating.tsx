...
// 1. Display mode(readOnly=true) — renders filled/half stars, purely visual
// 2. Input mode (readOnly=false) - interactive, fires onChange
    ...
    return (
        <div className={clsx('flex items-center gap-1', className)}>
            <div className="flex items-center gap-0.5">
                {[1, 2, 3, 4, 5].map((star) => {
                    // For display mode support half-stars via clip-path trick
