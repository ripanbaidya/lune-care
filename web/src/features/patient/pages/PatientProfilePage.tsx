...
const DisplayField: React.FC<{ label: string; value: string | null | undefined }>
    = ({label, value,}) => (
    <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                value={form.gender ?? ''}
                                onChange={handleChange}
                                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white"
                            >
