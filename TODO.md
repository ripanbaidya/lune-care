...
* Keep configurations isolated per service while maintaining a clean separation of concerns.
* Once validated, push configurations to the Config Server (git) repository.
...
* Ensure resilience is applied based on service communication patterns.

### 7. Rate Limiting & Correlation

* Implement **Redis-based Rate Limiting** for APIs.
* Add **Correlation ID support** across all services for request tracing and debugging.
